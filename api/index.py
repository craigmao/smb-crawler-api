...
async def api_all():
    ...
    names = ["wechat_search", "weibo_search", "zhihu_search", "bilibili_search", "toutiao_search", "baidu_search", "toutiao_hot", "weibo_hot", "douyin_hot"]
